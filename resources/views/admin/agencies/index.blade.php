                        ...
                        <td>
                            ...
                            <form id="edit-form-{{ $agency->id }}" action="{{ route('admin.agencies.update', $agency) }}" method="POST" style="display:none;">
                                ...
                                <div class="mt-2">
                                    ...
                                    <button type="button" class="btn btn-outline-secondary btn-sm" onclick="cancelEdit({{ $agency->id }})">Cancel</button>
                                </div>
                            </form>
                        </td>
                        <td>
                            <button class="btn btn-outline-dark btn-sm" onclick="toggleEdit({{ $agency->id }})">Edit</button>
