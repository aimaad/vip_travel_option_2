...
<?php $__env->startSection('content'); ?>
    ...
    <button id="show-add-agency-button" class="btn btn-outline-dark mb-3" onclick="toggleAddForm()">Add Agency</button>
    ...
    <div id="add-agency-form" style="display:none; background-color: white; padding: 20px; border: 1px solid #ddd; border-radius: 4px; margin-bottom: 20px;">
        ...
        <form action="<?php echo e(route('admin.agencies.store')); ?>" method="POST">
            ...
            <div>
                <button type="submit" class="btn btn-dark">Add Agency</button>
                        ...
                        <td>
                            ...
                            <form id="edit-form-<?php echo e($agency->id); ?>" action="<?php echo e(route('admin.agencies.update', $agency)); ?>" method="POST" style="display:none;">
                                ...
                                <div class="mt-2">
                                    ...
                                    <button type="button" class="btn btn-outline-secondary btn-sm" onclick="cancelEdit(<?php echo e($agency->id); ?>)">Cancel</button>
                                </div>
                            </form>
                        </td>
                        <td>
                            <button class="btn btn-outline-dark btn-sm" onclick="toggleEdit(<?php echo e($agency->id); ?>)">Edit</button>
                            <form action="<?php echo e(route('admin.agencies.destroy', $agency)); ?>" method="POST" style="display:inline;">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <button type="submit" class="btn btn-outline-dark btn-sm" onclick="return confirm('Are you sure?')">Delete</button>
                            </form>
                        </td>
                    </tr>
...
<?php echo $__env->make('Layout::admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Downloads\-booking-core-v3.6.1\BookingCore.3.6.1\resources\views/admin/agencies/index.blade.php ENDPATH**/ ?>