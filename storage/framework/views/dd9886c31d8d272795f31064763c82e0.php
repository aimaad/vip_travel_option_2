...
<?php echo app('Illuminate\Foundation\Vite')('resources/css/login_register.css'); ?>
...
<?php echo app('Illuminate\Foundation\Vite')('resources/js/auth-toggle.js'); ?> <!-- Include the external JavaScript file -->
<script>
      const translations = {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Desktop\Vip_travel\Vip_Travel_Project\resources\views/auth/login.blade.php ENDPATH**/ ?>