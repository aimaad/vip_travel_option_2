        ...
        <form action="<?php echo e(route('tour.vendor.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])); ?>" method="post">
            ...
            <div class="form-add-service">
                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                    ...
                    <a data-toggle="tab" href="#nav-attribute" aria-selected="false"><?php echo e(__("4. Status")); ?></a>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Downloads\-booking-core-v3.6.1\BookingCore.3.6.1\themes/Base/Tour/Views/frontend/manageTour/detail.blade.php ENDPATH**/ ?>