    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-12">
            <div class="form-container">
                ...
                <form class="form bravo-form-login" method="POST" action="<?php echo e(route('login')); ?>">
                    <?php echo csrf_field(); ?>
        ...
        <div class="col-lg-6 col-md-12">
            <div class="form-container">
                <form class="form bravo-form-register" method="POST" action="<?php echo e(route('auth.register.store')); ?>">
                    ...
                    <?php if(setting_item('facebook_enable') || setting_item('google_enable') || setting_item('twitter_enable')): ?>
                        <div class="advanced">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Desktop\Vip_travel\Vip_Travel_Project\resources\views/auth/auth.blade.php ENDPATH**/ ?>