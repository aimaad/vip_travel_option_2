 ...
 <?php endif; ?>
    ...
    <form action="<?php echo e(route('user.changeRole')); ?>" method="POST">
        ...
        <div class="form-group">
            <label><?php echo e(__("Nom d'agence (obligatoire):")); ?></label>
            <select id="agency_name" name="agency_name" class="form-control select2 agency-select" required>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <option value="other"><?php echo e(__("Other (please specify below)")); ?></option>
            </select>
        </div>
    
        <div class="form-group" id="other-agency-field" style="display:none;">
            <label><?php echo e(__("Ecrire votre nom d'agence:")); ?></label>
            <input type="text" id="other_agency_name" name="other_agency_name" class="form-control">
        </div>
    
        <div class="form-group">
            <label><?php echo e(__("IATA OU Office Id (non obligatoire):")); ?></label>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Desktop\Vip_travel\Vip_Travel_Project\resources\views/user/change_role.blade.php ENDPATH**/ ?>